...
class SideBarSpacer(Canvas):
    def __init__(self, parent, text, *args, **kwargs):
        ...
        self.text = Label(self, text=text, bg=self.frame_color, font=("Segoe UI Variable Display", 12), fg="#66fbfb")
...
class SideBarButton(Canvas):
    def __init__(self, parent, text, command, icon=None, tab=False, *args, **kwargs):
        ...
        Canvas.__init__(self, parent, width=198, height=60, bg=self.frame_color, highlightthickness=1, highlightbackground=self.frame_color, *args, **kwargs)
        self.pack()
        ...
        self.text = Label(self, text=text, font=("Segoe UI Variable Display", 12), bg=self.frame_color, fg="#66fbfb")
        self.text.place(x=30, y=17)
