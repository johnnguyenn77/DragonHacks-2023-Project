...
class Stopwatch:
    def __init__(self, root):
        ...
        close_btn = tk.Button(self.frame, fg = '#66fbfb', bd=0, width = 3, text = 'x', command = self.frame.place_forget, bg = '#222222', font = ("Segoe UI Variable Display", 12))
        close_btn.place(x = 246, y= 0)
